...
const Auth = () => {
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message.includes('For security purposes') || error.message.includes('email not confirmed')) {
        toast({
          title: "Conta criada com provedor social",
          description: "Sua conta foi criada com Google/GitHub. Entre normalmente ou crie uma nova conta com email/senha.",
          variant: "destructive",
        });
      } else {
        toast({
  ...
  const getDescription = () => {
    ...
    return isLogin ? 'Acesse sua conta no ORX Valley' : 'Junte-se à comunidade ORX Valley';
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-muted/50 px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto w-12 h-12 rounded-lg bg-orx-gradient flex items-center justify-center mb-4">
            <span className="text-white font-bold text-lg">ORX</span>
          </div>
